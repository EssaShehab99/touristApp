...
class ThemeApp {
  ...
  static ThemeData light = ThemeData(
      ...
      floatingActionButtonTheme: const FloatingActionButtonThemeData(
          backgroundColor: Color(0xFF2E9498)),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        fillColor: const Color(0xFFFDFAED),
        filled: true,
      ...
      textTheme: const TextTheme(
          ...
          headline5: TextStyle(
              fontWeight: FontWeight.bold,fontSize: 14, color: Color(0xFF2E9498)),
          bodyText1: TextStyle(
              fontWeight: FontWeight.w400,
              fontSize: 16,
          ...
          headlineLarge: TextStyle(
              fontWeight: FontWeight.w400,
              fontSize: 14,
              color: Color(0xFF2E9498)),
          bodyText2: TextStyle(fontSize: 14, color: Color(0xFF939393)),
          subtitle1: TextStyle(fontSize: 12, color: Color(0xFF2E9498)),
          subtitle2: TextStyle(fontSize: 12, color: Color(0xFF2E9498)),
